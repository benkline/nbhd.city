#!/bin/bash
# Complete Ticket Workflow Script
# Usage: source complete-ticket.sh
# Or pipe to Claude: cat .claude/complete-ticket.md | pbcopy
...
OUTPUT:
Success: DONE (ticket complete, tested, committed, pushed)
Blocked: BLOCKED (document blocker, update ticket, push progress)
EOF
